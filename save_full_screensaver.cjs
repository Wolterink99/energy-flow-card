          ...
          cards: [
            {
              ...
              show_battery: false,
              show_ev: true,
              car_type: "https://cdn.jsdelivr.net/gh/Wolterink99/energy-flow-card@0ee3d842e6336bb77f4dc6a9239b196afaa4f70a/volkswagen_tiguan.png",
              tap_action: {
                action: "navigate",
...
ws.on('message', (data) => {
  ...
  if (msg.type === 'auth_required') {
    ...
    console.log('Saving config with kiosk_mode...');
    ws.send(JSON.stringify({
      id: 1,
