    ...
    <svg viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clip-path="url(#scene-clip)">
        ...
        <g transform="translate(${translateX}, ${translateY})">
          ...
          <!-- Ground Flora (grass tufts, shrubs, flowers) to fill up the yard -->
          <g id="garden-flora" style="pointer-events: none;">
            <!-- LEFT SIDE (around electricity mast) -->
            <!-- Shrub 1 -->
            <g transform="translate(${mastX + 40}, 416)">
              <ellipse cx="0" cy="-5" rx="10" ry="6" fill="#15803d" opacity="0.9" />
              <ellipse cx="-5" cy="-8" rx="7" ry="5" fill="#166534" opacity="0.95" />
              <ellipse cx="5" cy="-7" rx="8" ry="5" fill="#14532d" opacity="0.95" />
              <ellipse cx="0" cy="-10" rx="7" ry="4" fill="#22c55e" opacity="0.8" />
            </g>
            <!-- Shrub 2 -->
            <g transform="translate(${mastX - 25}, 414)">
              <ellipse cx="0" cy="-4" rx="8" ry="5" fill="#166534" opacity="0.9" />
              <ellipse cx="4" cy="-6" rx="6" ry="4" fill="#14532d" opacity="0.95" />
              <ellipse cx="-2" cy="-8" rx="5" ry="3.5" fill="#22c55e" opacity="0.8" />
            </g>
            <!-- Grass Tufts -->
            <path d="M ${mastX + 10},412 Q ${mastX + 8},404 ${mastX + 6},402 Q ${mastX + 9},408 ${mastX + 10},412 M ${mastX + 10},412 Q ${mastX + 11},402 ${mastX + 12},400 Q ${mastX + 11},406 ${mastX + 10},412 M ${mastX + 10},412 Q ${mastX + 12},404 ${mastX + 14},402 Q ${mastX + 11},408 ${mastX + 10},412" stroke="#16a34a" stroke-width="1" fill="none" />
            <path d="M ${mastX + 110},416 Q ${mastX + 108},408 ${mastX + 106},406 Q ${mastX + 109},412 ${mastX + 110},416 M ${mastX + 110},416 Q ${mastX + 111},406 ${mastX + 112},404 Q ${mastX + 111},410 ${mastX + 110},416" stroke="#16a34a" stroke-width="1.2" fill="none" />
            <path d="M ${mastX - 60},415 Q ${mastX - 62},407 ${mastX - 64},405 Q ${mastX - 61},411 ${mastX - 60},415 M ${mastX - 60},415 Q ${mastX - 59},405 ${mastX - 58},403 Q ${mastX - 59},409 ${mastX - 60},415" stroke="#16a34a" stroke-width="1" fill="none" />
            <!-- Stray Flowers -->
            <!-- Daisy 1 -->
            <g transform="translate(${mastX + 80}, 418)">
              <line x1="0" y1="0" x2="-0.5" y2="-10" stroke="#16a34a" stroke-width="0.8" />
              <circle cx="-0.5" cy="-10" r="2.2" fill="#ffffff" />
              <circle cx="-0.5" cy="-10" r="0.8" fill="#facc15" />
            </g>
            <!-- Tulip 1 -->
            <g transform="translate(${mastX - 45}, 416)">
              <line x1="0" y1="0" x2="0.5" y2="-9" stroke="#16a34a" stroke-width="0.8" />
              <path d="M -1.5,-9 C -1.5,-12.5 -0.2,-13.2 -0.2,-13.2 C -0.2,-13.2 1.1,-12.5 1.1,-9 C 1.1,-8.2 -1.5,-8.2 -1.5,-9 Z" fill="#ef4444" />
            </g>
            <!-- Daisy 2 -->
            <g transform="translate(${mastX + 130}, 414)">
              <line x1="0" y1="0" x2="0.5" y2="-8" stroke="#16a34a" stroke-width="0.8" />
              <circle cx="0.5" cy="-8" r="2.0" fill="#ffffff" />
              <circle cx="0.5" cy="-8" r="0.7" fill="#facc15" />
            </g>

            <!-- RIGHT SIDE (former swimming pool lawn area) -->
            <!-- Shrub 3 -->
            <g transform="translate(685, 436)">
              <ellipse cx="0" cy="-6" rx="14" ry="8" fill="#15803d" opacity="0.9" />
              <ellipse cx="-7" cy="-10" rx="9" ry="7" fill="#166534" opacity="0.95" />
              <ellipse cx="7" cy="-9" rx="10" ry="7" fill="#14532d" opacity="0.95" />
              <ellipse cx="0" cy="-13" rx="9" ry="6" fill="#22c55e" opacity="0.8" />
            </g>
            <!-- Shrub 4 -->
            <g transform="translate(765, 428)">
              <ellipse cx="0" cy="-5" rx="11" ry="6" fill="#166534" opacity="0.9" />
              <ellipse cx="5" cy="-8" rx="8" ry="5.5" fill="#14532d" opacity="0.95" />
              <ellipse cx="-3" cy="-10" rx="7" ry="5" fill="#22c55e" opacity="0.8" />
            </g>
            <!-- Grass Tufts -->
            <path d="M 660,432 Q 658,424 656,422 Q 659,428 660,432 M 660,432 Q 661,422 662,420 Q 661,426 660,432 M 660,432 Q 662,424 664,422 Q 661,428 660,432" stroke="#16a34a" stroke-width="1.1" fill="none" />
            <path d="M 725,444 Q 723,436 721,434 Q 724,440 725,444 M 725,444 Q 726,434 727,432 Q 726,438 725,444" stroke="#16a34a" stroke-width="1" fill="none" />
            <path d="M 800,435 Q 798,427 796,425 Q 799,431 800,435 M 800,435 Q 801,425 802,423 Q 801,429 800,435 M 800,435 Q 802,427 804,425 Q 801,431 800,435" stroke="#16a34a" stroke-width="1.2" fill="none" />
            <!-- Stray Flowers -->
            <!-- Tulip 2 -->
            <g transform="translate(710, 440)">
              <line x1="0" y1="0" x2="-0.5" y2="-10" stroke="#16a34a" stroke-width="0.8" />
              <path d="M -2,-10 C -2,-13.5 -0.7,-14.2 -0.7,-14.2 C -0.7,-14.2 0.6,-13.5 0.6,-10 C 0.6,-9.2 -2,-9.2 -2,-10 Z" fill="#ef4444" />
            </g>
            <!-- Daisy 3 -->
            <g transform="translate(745, 432)">
              <line x1="0" y1="0" x2="0.5" y2="-9" stroke="#16a34a" stroke-width="0.8" />
              <circle cx="0.5" cy="-9" r="2.2" fill="#ffffff" />
              <circle cx="0.5" cy="-9" r="0.8" fill="#facc15" />
            </g>
            <!-- Daisy 4 -->
            <g transform="translate(790, 448)">
              <line x1="0" y1="0" x2="-0.5" y2="-8" stroke="#16a34a" stroke-width="0.8" />
              <circle cx="-0.5" cy="-8" r="2.0" fill="#ffffff" />
              <circle cx="-0.5" cy="-8" r="0.7" fill="#facc15" />
            </g>
...
class EnergyFlowCard extends i {
    ...
    render() {
        ...
        const showSolar = !!entities.solar || !!entities.solar_power;
