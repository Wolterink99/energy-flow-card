...
class EnergyDashboardCard extends i {
    constructor() {
        super(...arguments);
        this._selectedPeriod = 'vandaag';
        this._loadingStats = false;
        this._lastFetchTime = 0;
        this._calculatedSavingsToday = 2.36;
        this._hoveredHour = null;
        this._showRoi = false;
        this._activeDetailView = 'flow';
        this._batteryChartMode = 'kwh';
        this._historyData = {};
        this._hoverChartPoint = null;
    ...
    async _fetchHistoricalData() {
        if (!this.hass || this._loadingStats)
            return;
        ...
        try {
            ...
            try {
                const histRes = await this.hass.callWS({
            ...
            if (statsRes && statsRes['sensor.thuisbatterij_productie_vandaag']) {
                ...
                for (const p of prod) {
                    ...
                    if (disKwh > 0.01) {
                        ...
                        const match = forecast.find((f) => f.datetime && f.datetime.startsWith(timeIso.slice(0, 13)));
  ...
  `}
    ...
    _aggregateHistory5Min(entityId, startTime, endTime) {
    ...
    _renderDetailView() {
        ...
        const cH = 410;
        const cB = cT + cH; // 430
        const timeToX = (t) => cL + ((t - startTime) / (endTime - startTime)) * cW;
      ...
      <div class="detail-view-container">
        ...
        <div class="detail-chart-wrapper">
          <svg class="detail-chart-svg" viewBox="0 0 600 480"
            @mousemove="${(e) => this._handleChartMouseMove(e, cL, cR, cT, cB, startTime, endTime)}"
            ...
            if (this._activeDetailView === 'solar') {
                ...
                return w `
                  ...
                  ${areaPath ? w `<path d="${areaPath}" fill="url(#solar-chart-grad)" />` : ''}
                  ${linePath ? w `<path d="${linePath}" fill="none" stroke="#f59e0b" stroke-width="2.5" stroke-linecap="round" filter="drop-shadow(0 0 6px rgba(245, 158, 11, 0.4))" />` : ''}
                `;
            }
            if (this._activeDetailView === 'home') {
                ...
                return w `
                  ...
                  ${areaPath ? w `<path d="${areaPath}" fill="url(#home-chart-grad)" />` : ''}
                  ${linePath ? w `<path d="${linePath}" fill="none" stroke="#f1f5f9" stroke-width="2.2" stroke-linecap="round" />` : ''}
                `;
            }
            if (this._activeDetailView === 'battery') {
                if (this._batteryChartMode === 'kwh') {
                    ...
                    ${areaPath ? w `<path d="${areaPath}" fill="url(#bat-kwh-grad)" />` : ''}
                    ${linePath ? w `<path d="${linePath}" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" filter="drop-shadow(0 0 8px rgba(16, 185, 129, 0.5))" />` : ''}
                  ...
                  `;
                    ...
                    ${areaPath ? w `<path d="${areaPath}" fill="rgba(16, 185, 129, 0.18)" />` : ''}
                    ${linePath ? w `<path d="${linePath}" fill="none" stroke="#10b981" stroke-width="2.2" stroke-linecap="round" />` : ''}
                  `;
                }
            }
            if (this._activeDetailView === 'grid') {
                ...
                return w `
                  ...
                  ${areaPath ? w `<path d="${areaPath}" fill="rgba(56, 189, 248, 0.18)" />` : ''}
                  ${linePath ? w `<path d="${linePath}" fill="none" stroke="#38bdf8" stroke-width="2.2" stroke-linecap="round" />` : ''}
                `;
            }
            return '';
        })()}
    ...
    _handleChartMouseMove(e, cL, cR, cT, cB, startTime, endTime) {
...
EnergyDashboardCard.styles = i$3 `
    :host {
      display: block;
      width: 100%;
      height: 100%;
...
__decorate([
    n({ attribute: false })
], EnergyDashboardCard.prototype, "config", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_selectedPeriod", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_loadingStats", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_lastFetchTime", void 0);
__decorate([
    r()
...
__decorate([
    r()
], EnergyDashboardCard.prototype, "_activeDetailView", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_batteryChartMode", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_historyData", void 0);
__decorate([
    r()
], EnergyDashboardCard.prototype, "_hoverChartPoint", void 0);
...
const BRICK_TEXTURE_BASE64 = 'data:image/png;base64,';
...
function formatPowerAbs(watts) {
    const abs = Math.abs(watts);
    if (abs >= 1000)
        return `${(abs / 1000).toFixed(1)} kW`;
    return `${Math.round(abs)} W`;
}
function renderHDCloud(className, x, y, scale = 1, color = '#ffffff', opacity = 0.9, style = '') {
    return w `
...
function renderRain(width, intensity = 'normal') {
    let spacing = 18;
    ...
    <g style="pointer-events: none;">
      ${Array.from({ length: count }).map((_, i) => w `
...
const getOvercastDeckPath = (W, baseY, seed) => {
    let path = `M 0,${baseY}`;
    const segments = 12;
...
const getOvercastBottomLinePath = (W, baseY, seed) => {
    let path = `M 0,${baseY}`;
    const segments = 12;
    const segmentWidth = W / segments;
    for (let i = 0; i < segments; i++) {
...
const getPylonTips = (xOffset, yOffset, S) => {
    return [
...
const drawSaggingWire = (pStart, pEnd, sag) => {
    const midX = (pStart.x + pEnd.x) / 2;
    const midY = (pStart.y + pEnd.y) / 2 + sag;
    return `M ${pStart.x},${pStart.y} Q ${midX},${midY} ${pEnd.x},${pEnd.y}`;
};
const renderSinglePylon = (x, y, scale, opacity, strokeColor) => {
    return w `
...
function renderHouseSvg({ containerWidth, containerHeight, carType = 'hatchback', timeHour: rawTimeHour, timeOfDay, solar, solarToday, load, batteryPower, soc, charger, grid, showSolar, showBattery, showEV, weather = 'sunny', clouds = [], sunriseHour = 6.0, sunsetHour = 21.0, gridImportToday = null, gridExportToday = null, homeToday = null, batteryChargeToday = null, batteryDischargeToday = null, evToday = null, showLights: passedShowLights = undefined, gridPrice = null, rainIntensity = 'normal', windSpeed = 10, temperature = null, poolPumpActive = false, screensaver = false, useDashboardCircles = true, onNodeClick }) {
    ...
    if (showBattery)
        bottomCards.push({ id: 'battery', title: 'Thuisaccu', value: batteryCharging || batteryDischarging ? formatPowerAbs(batteryPower) : 'Standby', sub: batterySub, color: batColor.stroke, active: batteryCharging || batteryDischarging });
    ...
    if (showEV)
        bottomCards.push({ id: 'ev', title: 'Laadpaal (EV)', value: formatPowerAbs(charger), sub: evSub, color: COLORS.ev.stroke, active: evActive });
    // ── Particle and cable rendering ──
    const renderParticles = (path, active, speed, color, glow, reverse = false) => {
        if (!active || speed === 0)
            return w ``;
        const count = 3;
        return w `
    ...
    const renderCable = (path, active, speed, color, glow, reverse = false) => {
        return w `
    ...
    // When useDashboardCircles is active, lift the house & grass 40px higher for perfect circle breathing room
    const translateY = useDashboardCircles ? (height - 570) : (height - 530);
    const groundHeight = useDashboardCircles ? 170 : 120;
    return w `
    <svg viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clip-path="url(#scene-clip)">
        ...
        ${skyState.stars > 0.05 && visualWeather !== 'rainy' && visualWeather !== 'lightning' && visualWeather !== 'cloudy' ? w `
        ...
        ${isSunVisible && visualWeather !== 'rainy' && visualWeather !== 'lightning' && visualWeather !== 'snowy' && visualWeather !== 'foggy' ? w `
          <style>
            @keyframes flyBird1 {
        ...
        <!-- Cloud layers -->
        ${(visualWeather === 'cloudy' || visualWeather === 'rainy' || visualWeather === 'lightning' || visualWeather === 'snowy') ? w `
          <style>
          ...
          <g opacity="${cloudOpacity}" style="pointer-events: none;">
            ...
            <g class="cloud-layer-back">
              ...
              <path d="${getOvercastDeckPath(width, 95, 2)}" fill="${interpolateColor(cloudColor, '#111827', 0.20)}" />
              <path d="${getOvercastDeckPath(width, 95, 2)}" transform="translate(${width}, 0)" fill="${interpolateColor(cloudColor, '#111827', 0.20)}" />
              <path d="${getOvercastBottomLinePath(width, 95, 2)}" fill="none" stroke="rgba(255,255,255,0.03)" stroke-width="1.5" style="filter: drop-shadow(0 4px 6px rgba(0,0,0,0.22));" />
              <path d="${getOvercastBottomLinePath(width, 95, 2)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.03)" stroke-width="1.5" style="filter: drop-shadow(0 4px 6px rgba(0,0,0,0.22));" />

              <path d="${getOvercastDeckPath(width, 60, 1)}" fill="${interpolateColor(cloudColor, '#111827', 0.25)}" />
              <path d="${getOvercastDeckPath(width, 60, 1)}" transform="translate(${width}, 0)" fill="${interpolateColor(cloudColor, '#111827', 0.25)}" />
              <path d="${getOvercastBottomLinePath(width, 60, 1)}" fill="none" stroke="rgba(255,255,255,0.03)" stroke-width="1.5" style="filter: drop-shadow(0 4px 6px rgba(0,0,0,0.22));" />
              <path d="${getOvercastBottomLinePath(width, 60, 1)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.03)" stroke-width="1.5" style="filter: drop-shadow(0 4px 6px rgba(0,0,0,0.22));" />
            </g>
            
            <!-- Layer 2 (Middle - Medium) -->
            <g class="cloud-layer-mid">
              <!-- Y=120 first, Y=85 last -->
              <path d="${getOvercastDeckPath(width, 120, 4)}" fill="${interpolateColor(cloudColor, '#1f2937', 0.10)}" />
              <path d="${getOvercastDeckPath(width, 120, 4)}" transform="translate(${width}, 0)" fill="${interpolateColor(cloudColor, '#1f2937', 0.10)}" />
              <path d="${getOvercastBottomLinePath(width, 120, 4)}" fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="1.5" style="filter: drop-shadow(0 5px 8px rgba(0,0,0,0.25));" />
              <path d="${getOvercastBottomLinePath(width, 120, 4)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="1.5" style="filter: drop-shadow(0 5px 8px rgba(0,0,0,0.25));" />

              <path d="${getOvercastDeckPath(width, 85, 3)}" fill="${interpolateColor(cloudColor, '#1f2937', 0.15)}" />
              <path d="${getOvercastDeckPath(width, 85, 3)}" transform="translate(${width}, 0)" fill="${interpolateColor(cloudColor, '#1f2937', 0.15)}" />
              <path d="${getOvercastBottomLinePath(width, 85, 3)}" fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="1.5" style="filter: drop-shadow(0 5px 8px rgba(0,0,0,0.25));" />
              <path d="${getOvercastBottomLinePath(width, 85, 3)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.04)" stroke-width="1.5" style="filter: drop-shadow(0 5px 8px rgba(0,0,0,0.25));" />
            </g>
            
            <!-- Layer 3 (Front - Main Color) -->
            <g class="cloud-layer-front">
              <!-- Y=150 first, Y=110 last -->
              <path d="${getOvercastDeckPath(width, 150, 6)}" fill="${cloudColor}" />
              <path d="${getOvercastDeckPath(width, 150, 6)}" transform="translate(${width}, 0)" fill="${cloudColor}" />
              <path d="${getOvercastBottomLinePath(width, 150, 6)}" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" style="filter: drop-shadow(0 6px 10px rgba(0,0,0,0.28));" />
              <path d="${getOvercastBottomLinePath(width, 150, 6)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" style="filter: drop-shadow(0 6px 10px rgba(0,0,0,0.28));" />

              <path d="${getOvercastDeckPath(width, 110, 5)}" fill="${interpolateColor(cloudColor, '#ffffff', 0.04)}" />
              <path d="${getOvercastDeckPath(width, 110, 5)}" transform="translate(${width}, 0)" fill="${interpolateColor(cloudColor, '#ffffff', 0.04)}" />
              <path d="${getOvercastBottomLinePath(width, 110, 5)}" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" style="filter: drop-shadow(0 6px 10px rgba(0,0,0,0.28));" />
              <path d="${getOvercastBottomLinePath(width, 110, 5)}" transform="translate(${width}, 0)" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" style="filter: drop-shadow(0 6px 10px rgba(0,0,0,0.28));" />
            </g>
          </g>
        ` : w `
        ...
        return renderHDCloud('customDriftCloud', 0, cloudY, c.scale, cloudColor, c.opacityMultiplier, `animation-duration: ${c.speed}s; animation-delay: ${c.delay}s;`);
    })}
          </g>
        `}

        <!-- Lightning bolts (background, shifted dynamically to remain centered) -->
        ${visualWeather === 'lightning' ? w `
        ...
        <g transform="translate(${translateX}, ${translateY})">
          ...
          <rect x="${-translateX}" y="410" width="${width}" height="${groundHeight}" fill="url(#garden-grad)" />
          ...
          ${showSolar ? w `
            <g id="solar-panels" class="interactiveGroup solarGroup" @click=${(e) => { e.stopPropagation(); onNodeClick('solar'); }}>
          ...
          <!-- ── EV CHARGER ── -->
          ${showEV ? w `
            <g id="ev-charger" class="interactiveGroup evGroup" @click=${(e) => { e.stopPropagation(); onNodeClick('ev'); }}>
            ...
            <!-- EV Car -->
            <g id="ev-car" class="interactiveGroup evGroup" opacity="${evActive ? 1.0 : 0.4}" style="transition: opacity 0.6s ease;" @click=${(e) => { e.stopPropagation(); onNodeClick('ev'); }}>
              ${carType && (carType.startsWith('/') || carType.startsWith('http') || carType.includes('.') || carType.includes('/')) ? w `
        ...
        return w `<line x1="32" y1="50" x2="${32 + Math.cos(angle) * 10}" y2="${50 + Math.sin(angle) * 10}" stroke="#cbd5e1" stroke-width="1.2" />`;
    })}
                  <circle cx="118" cy="50" r="16" fill="#090d16" />
                  <circle cx="118" cy="50" r="10" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({ length: 6 }).map((_, idx) => {
        const angle = (idx * Math.PI) / 3;
        return w `<line x1="118" y1="50" x2="${118 + Math.cos(angle) * 10}" y2="${50 + Math.sin(angle) * 10}" stroke="#cbd5e1" stroke-width="1.2" />`;
    })}
                </g>
              ` : ''}
              ${carType === 'sedan' ? w `
        ...
        return w `<line x1="30" y1="44" x2="${30 + Math.cos(angle) * 8.5}" y2="${44 + Math.sin(angle) * 8.5}" stroke="#cbd5e1" stroke-width="1.2" />`;
    })}
                  <circle cx="103" cy="44" r="13.5" fill="#090d16" />
                  <circle cx="103" cy="44" r="8.5" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({ length: 7 }).map((_, idx) => {
        const angle = (idx * 2 * Math.PI) / 7;
        return w `<line x1="103" y1="44" x2="${103 + Math.cos(angle) * 8.5}" y2="${44 + Math.sin(angle) * 8.5}" stroke="#cbd5e1" stroke-width="1.2" />`;
    })}
                </g>
              ` : ''}
              ${carType === 'suv' ? w `
        ...
        return w `<line x1="31" y1="54" x2="${31 + Math.cos(angle) * 10}" y2="${54 + Math.sin(angle) * 10}" stroke="#cbd5e1" stroke-width="1.5" />`;
    })}
                  <circle cx="104" cy="54" r="15.5" fill="#090d16" />
                  <circle cx="104" cy="54" r="10" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({ length: 5 }).map((_, idx) => {
        const angle = (idx * 2 * Math.PI) / 5;
        return w `<line x1="104" y1="54" x2="${104 + Math.cos(angle) * 10}" y2="${54 + Math.sin(angle) * 10}" stroke="#cbd5e1" stroke-width="1.5" />`;
    })}
                </g>
              ` : ''}
            </g>
          ...
          ${showBattery ? renderCable(batteryPath, batteryCharging || batteryDischarging, getFlowSpeed(batteryPower), batColor.stroke, batColor.glow, batteryCharging) : ''}

          ${showEV ? renderCable(evPath, evActive, getFlowSpeed(charger), COLORS.ev.stroke, COLORS.ev.glow) : ''}
          ...
          <g class="interactiveGroup weatherGroup" @click=${() => onNodeClick('weather')}>
            <g transform="translate(${width - 190}, 20)">
              ...
              <text x="12" y="53" class="hudSub">
                ${WEATHER_TRANSLATIONS$1[weather] || weather}
              </text>
            </g>
          </g>
        ` : ''}
        ...
        <!-- ════════════════════════════════════════════════════════════════ -->
        ${(() => {
        // Pre-calculate segmented proportions for Net & Thuis rings
        const circ = 289.03; // 2 * Math.PI * 46
        // Net Export Proportions (Zon vs Batterij)
        const netAbs = Math.abs(grid);
        const batExpPwr = batteryDischarging ? Math.abs(batteryPower) : 0;
        const solExpPwr = solarActive ? Math.abs(solar) : 0;
        const batPortionNet = Math.min(netAbs, batExpPwr);
        const solPortionNet = Math.min(solExpPwr, Math.max(0, netAbs - batPortionNet));
        const totalNetPortions = Math.max(0.1, batPortionNet + solPortionNet);
        const lenNetSol = gridExporting ? Math.min(circ, (solPortionNet / totalNetPortions) * circ) : 0;
        const lenNetBat = gridExporting ? Math.min(circ, (batPortionNet / totalNetPortions) * circ) : 0;
        const offsetNetSol = 0;
        const offsetNetBat = -lenNetSol;
        // Thuis Consumption Proportions (Zon vs Batterij vs Net)
        const homeAbs = Math.max(0.1, load);
        const solToHome = Math.min(homeAbs, solarActive ? solar : 0);
        const batToHome = Math.min(homeAbs - solToHome, batteryDischarging ? Math.abs(batteryPower) : 0);
        const gridToHome = Math.max(0, homeAbs - solToHome - batToHome);
        const lenHomeSol = Math.min(circ, (solToHome / homeAbs) * circ);
        const lenHomeBat = Math.min(circ, (batToHome / homeAbs) * circ);
        const lenHomeGrid = Math.min(circ, (gridToHome / homeAbs) * circ);
        const offsetHomeSol = 0;
        const offsetHomeBat = -lenHomeSol;
        const offsetHomeGrid = -(lenHomeSol + lenHomeBat);
        const yBottomCircle = height - 72;
        return w `
            <!-- ════════════════════════════════════════════════════════════════ -->
            <!-- SOLAR HUD (Circle vs Original Card)                              -->
            <!-- ════════════════════════════════════════════════════════════════ -->
            ${showSolar ? (useDashboardCircles ? w `
              ...
              <g class="interactiveGroup solarGroup" transform="translate(${translateX + 215}, ${translateY + 120})" style="cursor: pointer;" @click=${() => onNodeClick('solar')}>
                <text x="0" y="-54" fill="#f59e0b" font-size="12" font-weight="700" text-anchor="middle" letter-spacing="0.3px">Zon</text>
                <circle cx="0" cy="0" r="46" fill="none" stroke="rgba(255, 255, 255, 0.14)" stroke-width="6" />
                ${solarActive ? w `
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#f59e0b" stroke-width="6"
                    stroke-dasharray="${circ}" stroke-dashoffset="0" transform="rotate(-90)" stroke-linecap="round" filter="drop-shadow(0 0 6px rgba(245, 158, 11, 0.5))" />
                ` : ''}
                <circle cx="0" cy="0" r="37" fill="#11151f" stroke="rgba(245, 158, 11, 0.28)" stroke-width="1.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.65))" />
                <text x="0" y="-18" fill="#f59e0b" font-size="9" font-weight="600" text-anchor="middle">${solarToday !== null ? `${solarToday.toFixed(1)} kWh` : 'Zon'}</text>
                <g transform="translate(0, -6)">
                  <circle cx="0" cy="0" r="3.8" fill="none" stroke="#f59e0b" stroke-width="1.4" />
                  <line x1="0" y1="-7" x2="0" y2="-5.2" stroke="#f59e0b" stroke-width="1.4" />
                  <line x1="0" y1="5.2" x2="0" y2="7" stroke="#f59e0b" stroke-width="1.4" />
                  <line x1="-7" y1="0" x2="-5.2" y2="0" stroke="#f59e0b" stroke-width="1.4" />
                  <line x1="5.2" y1="0" x2="7" y2="0" stroke="#f59e0b" stroke-width="1.4" />
                </g>
                <text x="0" y="11" fill="#ffffff" font-size="13" font-weight="700" text-anchor="middle">${solarActive ? formatPowerAbs(solar) : '0 W'}</text>
                <rect x="-28" y="17" width="56" height="14" rx="7" fill="${solarActive ? 'rgba(245, 158, 11, 0.22)' : 'rgba(255,255,255,0.06)'}" />
                <text x="0" y="27" fill="${solarActive ? '#fbbf24' : '#94a3b8'}" font-size="8" font-weight="700" text-anchor="middle">${solarActive ? 'Opwekking' : 'Standby'}</text>
            ...
            <!-- ════════════════════════════════════════════════════════════════ -->
            <!-- BOTTOM HUD (Dashboard Circles vs Original Cards)                 -->
            <!-- ════════════════════════════════════════════════════════════════ -->
            ${useDashboardCircles ? w `
              <!-- 1. Stroomnet Cirkel (Blauw als basis, gedeeld bij teruglevering met zon & accu) -->
              <g class="interactiveGroup gridGroup" transform="translate(105, ${yBottomCircle})" style="cursor: pointer;" @click=${() => onNodeClick('grid')}>
                <text x="0" y="-54" fill="#38bdf8" font-size="12" font-weight="700" text-anchor="middle" letter-spacing="0.3px">Net</text>
                
                <!-- Base track -->
                <circle cx="0" cy="0" r="46" fill="none" stroke="rgba(56, 189, 248, 0.18)" stroke-width="6" />
                
                ${gridImporting ? w `
                  <!-- Import: Volledig blauw -->
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#38bdf8" stroke-width="6"
                    stroke-dasharray="${circ}" stroke-dashoffset="0" transform="rotate(-90)" stroke-linecap="round" filter="drop-shadow(0 0 6px rgba(56, 189, 248, 0.5))" />
                ` : gridExporting ? w `
                  <!-- Teruglevering: Gedeelde cirkel met Zonnestroom (amber) & Batterijstroom (groen)! -->
                  ${lenNetSol > 0 ? w `
                    <circle cx="0" cy="0" r="46" fill="none" stroke="#f59e0b" stroke-width="6"
                      stroke-dasharray="${lenNetSol} ${circ}" stroke-dashoffset="${offsetNetSol}" transform="rotate(-90)" filter="drop-shadow(0 0 6px rgba(245, 158, 11, 0.5))" />
                  ` : ''}
                  ${lenNetBat > 0 ? w `
                    <circle cx="0" cy="0" r="46" fill="none" stroke="#10b981" stroke-width="6"
                      stroke-dasharray="${lenNetBat} ${circ}" stroke-dashoffset="${offsetNetBat}" transform="rotate(-90)" filter="drop-shadow(0 0 6px rgba(16, 185, 129, 0.5))" />
                  ` : ''}
                ` : ''}

                <!-- Dark solid disc background -->
                <circle cx="0" cy="0" r="37" fill="#11151f" stroke="rgba(56, 189, 248, 0.28)" stroke-width="1.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.65))" />
                
                <!-- Top text: Afname & Teruglevering kWh -->
                <text x="0" y="-18" fill="#94a3b8" font-size="8.5" font-weight="600" text-anchor="middle">
                  ${gridImportToday !== null && gridExportToday !== null ? `↓${gridImportToday.toFixed(1)}  ↑${gridExportToday.toFixed(1)}` : (gridPriceLabel || 'Net')}
                </text>
                
                <!-- Center Pylon Icon in Net Blue -->
                <g transform="translate(0, -6)">
                  <path d="M-5 4 L5 4 M-3.5 -1 L3.5 -1 M0 -7 L0 5" stroke="#38bdf8" stroke-width="1.5" fill="none" />
                </g>
                
                <!-- Power Value -->
                <text x="0" y="11" fill="#38bdf8" font-size="13" font-weight="700" text-anchor="middle">
                  ${gridImporting || gridExporting ? formatPowerAbs(grid) : '0 W'}
                </text>
                
                <!-- Status Pill -->
                <rect x="-29" y="17" width="58" height="14" rx="7" fill="${gridImporting ? 'rgba(56, 189, 248, 0.22)' : gridExporting ? 'rgba(16, 185, 129, 0.22)' : 'rgba(255,255,255,0.06)'}" />
                <text x="0" y="27" fill="${gridImporting ? '#38bdf8' : gridExporting ? '#34d399' : '#94a3b8'}" font-size="8" font-weight="700" text-anchor="middle">
              ...
              <!-- 2. Thuisaccu Cirkel -->
              ${showBattery ? w `
                <g class="interactiveGroup batteryGroup" transform="translate(${batteryX + 85}, ${yBottomCircle})" style="cursor: pointer;" @click=${() => onNodeClick('battery')}>
                  <text x="0" y="-54" fill="#10b981" font-size="12" font-weight="700" text-anchor="middle" letter-spacing="0.3px">Batterij</text>
                  <circle cx="0" cy="0" r="46" fill="none" stroke="rgba(255, 255, 255, 0.14)" stroke-width="6" />
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#10b981" stroke-width="6"
                    stroke-dasharray="${circ}" stroke-dashoffset="${circ * (1 - Math.min(100, Math.max(0, soc)) / 100)}"
                    transform="rotate(-90)" stroke-linecap="round" filter="drop-shadow(0 0 6px rgba(16, 185, 129, 0.5))" />
                  
                  <circle cx="0" cy="0" r="37" fill="#11151f" stroke="rgba(16, 185, 129, 0.28)" stroke-width="1.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.65))" />
                  <text x="0" y="-18" fill="#10b981" font-size="9.5" font-weight="700" text-anchor="middle">${soc} %</text>
                  
                  <g transform="translate(0, -6)">
                    <rect x="-5.5" y="-4" width="11" height="7" rx="1.5" fill="none" stroke="#10b981" stroke-width="1.3" />
                    <line x1="5.5" y1="-1.5" x2="7.5" y2="-1.5" stroke="#10b981" stroke-width="1.3" />
                    <polygon points="1 -2.5 -1 0.2 1.5 0.2 -0.5 2.5 2 -0.2 0 -0.2 1 -2.5" fill="#10b981" stroke="none" />
                  </g>
                  
                  <text x="0" y="11" fill="#ffffff" font-size="13" font-weight="700" text-anchor="middle">
                    ${batteryCharging || batteryDischarging ? formatPowerAbs(batteryPower) : '0 W'}
                  </text>
                  
                  <rect x="-29" y="17" width="58" height="14" rx="7" fill="${batteryCharging ? 'rgba(16, 185, 129, 0.22)' : batteryDischarging ? 'rgba(245, 158, 11, 0.22)' : 'rgba(255,255,255,0.06)'}" />
                  <text x="0" y="27" fill="${batteryCharging ? '#34d399' : batteryDischarging ? '#fbbf24' : '#94a3b8'}" font-size="8" font-weight="700" text-anchor="middle">
              ...
              <g class="interactiveGroup homeGroup" transform="translate(${homeX + 85}, ${yBottomCircle})" style="cursor: pointer;" @click=${() => onNodeClick('home')}>
                <text x="0" y="-54" fill="#ffffff" font-size="12" font-weight="700" text-anchor="middle" letter-spacing="0.3px">Thuis</text>
                <circle cx="0" cy="0" r="46" fill="none" stroke="rgba(255, 255, 255, 0.14)" stroke-width="6" />
                
                <!-- Gedeelde ring voor Thuis (Zon in amber, Accu in groen, Net in blauw) -->
                ${lenHomeSol > 0 ? w `
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#f59e0b" stroke-width="6"
                    stroke-dasharray="${lenHomeSol} ${circ}" stroke-dashoffset="${offsetHomeSol}" transform="rotate(-90)" />
                ` : ''}
                ${lenHomeBat > 0 ? w `
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#10b981" stroke-width="6"
                    stroke-dasharray="${lenHomeBat} ${circ}" stroke-dashoffset="${offsetHomeBat}" transform="rotate(-90)" />
                ` : ''}
                ${lenHomeGrid > 0 ? w `
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#38bdf8" stroke-width="6"
                    stroke-dasharray="${lenHomeGrid} ${circ}" stroke-dashoffset="${offsetHomeGrid}" transform="rotate(-90)" />
                ` : ''}

                <circle cx="0" cy="0" r="37" fill="#11151f" stroke="rgba(255, 255, 255, 0.2)" stroke-width="1.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.65))" />
                <text x="0" y="-18" fill="#cbd5e1" font-size="9" font-weight="600" text-anchor="middle">${homeToday !== null ? `${homeToday.toFixed(1)} kWh` : 'Thuis'}</text>
                
                <g transform="translate(0, -6)">
                  <path d="M-5.5 -1 L0 -6 L5.5 -1 L5.5 4 L-5.5 4 Z" fill="none" stroke="#ffffff" stroke-width="1.4" />
                </g>
                ...
                <rect x="-29" y="17" width="58" height="14" rx="7" fill="rgba(255, 255, 255, 0.14)" />
                <text x="0" y="27" fill="#f8fafc" font-size="8" font-weight="700" text-anchor="middle">
              ...
              ${showEV ? w `
                <g class="interactiveGroup evGroup" transform="translate(${evX + 85}, ${yBottomCircle})" style="cursor: pointer;" @click=${() => onNodeClick('ev')}>
                  <text x="0" y="-54" fill="#a855f7" font-size="12" font-weight="700" text-anchor="middle" letter-spacing="0.3px">Laadpaal</text>
                  <circle cx="0" cy="0" r="46" fill="none" stroke="rgba(255, 255, 255, 0.14)" stroke-width="6" />
                  <circle cx="0" cy="0" r="46" fill="none" stroke="#a855f7" stroke-width="6"
                    stroke-dasharray="${circ}" stroke-dashoffset="0" transform="rotate(-90)" stroke-linecap="round" />
                  <circle cx="0" cy="0" r="37" fill="#11151f" stroke="rgba(168, 85, 247, 0.28)" stroke-width="1.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.65))" />
                  <text x="0" y="-18" fill="#c084fc" font-size="9" font-weight="600" text-anchor="middle">${evToday !== null ? `${evToday.toFixed(1)} kWh` : 'EV'}</text>
                  <text x="0" y="11" fill="#ffffff" font-size="13" font-weight="700" text-anchor="middle">${evActive ? formatPowerAbs(charger) : '0 W'}</text>
                  <rect x="-29" y="17" width="58" height="14" rx="7" fill="${evActive ? 'rgba(168, 85, 247, 0.22)' : 'rgba(255,255,255,0.06)'}" />
                  <text x="0" y="27" fill="${evActive ? '#c084fc' : '#94a3b8'}" font-size="8" font-weight="700" text-anchor="middle">${evActive ? 'Laden' : 'Standby'}</text>
                  <circle cx="0" cy="0" r="50" fill="transparent" />
                </g>
              ` : ''}
            ` : w `
              <!-- ── ORIGINELE RECHTHOEKIGE KAARTJES (100% BEWAARD VOOR TERUGZETTEN) ──── -->
              <!-- 1. Stroomnet -->
...
function getWeatherIconSvg(condition, isNight = false, size = 20) {
    let cond = condition;
...
class EnergyFlowCard extends i {
    ...
    async fetchHighResolutionHistory() {
        ...
        const batteryEnt = this.config?.entities.battery_power || (this.config?.entities).battery;
        console.info('[energy-flow-card] Configured entities for history:', { solarEnt, homeEnt, gridEnt, batteryEnt });
        if (!solarEnt && !homeEnt && !gridEnt && !batteryEnt)
            return;
    ...
    async fetchStatsData(entityIds) {
        ...
        try {
            ...
            const hourlyRes = await this.hass.callWS({
                type: 'recorder/statistics_during_period',
    ...
    getProcessedGridData(importEntity, exportEntity) {
    ...
    getProcessedHourlySingleData(entityId) {
    ...
    getProcessedHourlyGridData(importEntity, exportEntity) {
    ...
    renderUnifiedLineChart(chartType = 'unified') {
        ...
        const aggregate5MinHistory = (entId) => {
        ...
        const batteryPowerEnt = this.config?.entities.battery_power || (this.config?.entities).battery || '';
      ...
      <div style="display: block !important; width: 100% !important; height: 260px !important; position: relative !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important;">
        ...
        <svg viewBox="0 0 500 240" style="display: block !important; width: 100% !important; height: 250px !important; margin: 0 !important; padding: 0 !important; background: rgba(255,255,255,0.02) !important; border-radius: 8px;">
          ...
          <!-- Solar Envelope & Line -->
          ${(chartType === 'unified' || chartType === 'solar') && solarPaths.line ? w `
          ...
          <!-- Home Envelope & Line -->
          ${(chartType === 'unified' || chartType === 'home') && homePaths.line ? w `
          ...
          ${chartType === 'battery' && batteryChargeLinePath ? w `
          ...
          ` : ''}
          ${chartType === 'battery' && batteryDischargeLinePath ? w `
    ...
    renderPopup() {
      ...
      `;
        ...
        let costTodayImport = null;
        let costTodayExport = null;
        ...
        if (this.activePopup === 'weather') {
            ...
            if (pressure === undefined || pressure === null) {
                const fallbackEntity = Object.values(this.hass?.states || {}).find(ent => ent.entity_id.startsWith('weather.') && ent.attributes.pressure !== undefined && ent.attributes.pressure !== null);
                if (fallbackEntity) {
            ...
            return b `
        <div class="glass-popup-overlay" @click=${this.closePopup}>
          <div class="glass-popup-card" style="height: auto;" @click=${(e) => e.stopPropagation()}>
            <button class="glass-popup-close" @click=${this.closePopup}>&times;</button>
      ...
      `;
        ...
        const grid = this.getEntityValue(entities.grid || entities.grid_power);
        ...
        if (this.activePopup === 'solar') {
            ...
            const solar = this.getEntityValue(entities.solar || entities.solar_power);
            const solarToday = this.parseEntityFloat(entities.solar_energy_today || entities.solar_today);
            ...
            if (this.activeTab === 'today') {
                ...
                if (this.isLoadingHistory) {
                    ...
                    chartHtml = b `<div class="chart-no-data">Geen historische gegevens beschikbaar.</div>`;
                }
                else {
          ...
          `;
            ...
            const load = this.getEntityValue(entities.load || entities.home_power);
          ...
          `;
            ...
            const getTodayCostFromStats = (entityId) => {
                const pts = this.statsData[entityId];
                if (!pts || pts.length === 0)
                    return null;
                const todayPt = pts.find((p) => new Date(p.start).toDateString() === todayDateStr);
                if (!todayPt)
                    return null;
            ...
            if (this.activeTab === 'prices') {
                ...
                if (forecast.length === 0) {
                    chartHtml = b `<div class="chart-no-data">Geen prijsinformatie beschikbaar.</div>`;
                }
                else {
                    ...
                    const currentPt = points.find((p) => p.isCurrent);
                    ...
                    const maxPt = points.reduce((max, p) => p.price > max.price ? p : max, points[0]);
                    const minPt = points.reduce((min, p) => p.price < min.price ? p : min, points[0]);
                    // Grid lines
                    const gridLines = [];
            ...
            <div class="scrollable-chart-container" style="display: block !important; padding-top: 5px; height: 165px; overflow-y: hidden; overflow-x: hidden; position: relative;">
              <svg viewBox="0 0 500 190" style="display: block; width: 100%; height: 155px !important;">
                ...
                <!-- Peak Marker Bubble -->
                ${maxPt && (!this.hoveredPoint || this.hoveredPoint !== maxPt) ? w `
                ...
                ${minPt && minPt !== maxPt && (!this.hoveredPoint || this.hoveredPoint !== minPt) ? w `
                ...
                ${points.map((p) => {
                    ...
                    <rect x="${p.x - step / 2}" y="${chartTop - 15}" width="${step}" height="${chartHeight + 35}" 
                          ...
                          @touchstart=${(e) => { e.preventDefault(); this.hoveredPoint = p; }}
                          @touchmove=${(e) => {
                            e.preventDefault();
          ...
          `;
            ...
            const rawBatteryPower = this.getEntityValue(entities.battery_power || entities.battery);
            const soc = entities.battery_soc || entities.battery_percentage ? this.getEntityValue(entities.battery_soc || entities.battery_percentage) : 0;
        ...
        return b `
      <div class="glass-popup-overlay" @click=${this.closePopup}>
        <div class="glass-popup-card" @click=${(e) => e.stopPropagation()}>
          <button class="glass-popup-close" @click=${this.closePopup}>&times;</button>
          ...
          <div class="glass-popup-stats">
            ${this.activePopup === 'grid' ? (this.activeTab === 'prices' ? b `
                <div class="glass-popup-stat" style="grid-column: span 2; display: flex; flex-direction: column; gap: 8px; padding: 12px 16px; background: rgba(255,255,255,0.03); border-radius: 12px; border: 1px solid rgba(255,255,255,0.08); width: 100%; box-sizing: border-box;">
                  ...
                  <div style="display: flex; justify-content: space-between; align-items: center; font-size: 13px;">
                    ...
                    <span style="font-weight: bold; color: #ffffff;">
                      ...
                      ${canShowCost && costTodayImport !== null ? b `<span style="color: #ef4444; font-weight: bold; margin-left: 6px;">(€ ${costTodayImport.toFixed(2).replace('.', ',')})</span>` : ''}
                    </span>
                  </div>
                  ...
                  <div style="display: flex; justify-content: space-between; align-items: center; font-size: 13px;">
                    ...
                    <span style="font-weight: bold; color: #ffffff;">
                      ...
                      ${canShowCost && costTodayExport !== null ? b `<span style="color: #10b981; font-weight: bold; margin-left: 6px;">(€ ${costTodayExport.toFixed(2).replace('.', ',')})</span>` : ''}
                    </span>
                  </div>
                  ...
                  <div style="display: flex; justify-content: space-between; align-items: center; font-size: 13px; font-weight: bold;">
                    ...
                    <span style="color: ${(gridImportToday || 0) >= (gridExportToday || 0) ? '#ef4444' : '#10b981'};">
                      ...
                      ${canShowCost && costTodayImport !== null && costTodayExport !== null ? b `
              ...
              ` : b `
                <div class="glass-popup-stat" style="grid-column: span 2; display: flex; flex-direction: column; gap: 8px; padding: 12px 16px; background: rgba(255,255,255,0.03); border-radius: 12px; border: 1px solid rgba(255,255,255,0.08); width: 100%; box-sizing: border-box;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-size: 13px;">
                    ...
                    <span style="font-weight: bold; color: #ffffff;">
                      ${totalImport.toFixed(1)} kWh ${canShowCost ? b `<span style="color: #ef4444; font-weight: bold; margin-left: 6px;">(€ ${totalImportCost.toFixed(2).replace('.', ',')})</span>` : ''}
                    </span>
                  </div>
                  ...
                  <div style="display: flex; justify-content: space-between; align-items: center; font-size: 13px;">
                    ...
                    <span style="font-weight: bold; color: #ffffff;">
                      ${totalExport.toFixed(1)} kWh ${canShowCost ? b `<span style="color: #10b981; font-weight: bold; margin-left: 6px;">(€ ${totalExportCost.toFixed(2).replace('.', ',')})</span>` : ''}
                    </span>
                  </div>
    ...
    getEntityValue(entityInput) {
        if (!entityInput || !this.hass)
            return 0;
        const resolveValue = (entId) => {
            const entity = this.hass?.states[entId];
            if (!entity)
                return 0;
    ...
    async handleNodeClick(nodeId) {
        ...
        if (nodeId === 'solar' || nodeId === 'home' || nodeId === 'grid' || nodeId === 'weather' || nodeId === 'battery') {
            ...
            if (nodeId === 'solar') {
                ...
                if (imp)
                    entitiesToFetch.push(imp);
                if (exp)
                    entitiesToFetch.push(exp);
                ...
                if (impCost)
                    entitiesToFetch.push(impCost);
                if (expCost)
                    entitiesToFetch.push(expCost);
            }
                ...
                if (entChg)
                    entitiesToFetch.push(entChg);
                if (entDis)
                    entitiesToFetch.push(entDis);
            }
        ...
        const customAction = this.config[actionKey];
        if (customAction) {
        ...
        if (nodeId === 'battery') {
            ...
            entityKey = this.config?.entities.grid ? 'grid' : ((this.config?.entities).grid_power ? 'grid_power' : 'solar');
        }
        else if (nodeId === 'solar') {
            entityKey = this.config?.entities.solar ? 'solar' : ((this.config?.entities).solar_power ? 'solar_power' : 'solar_energy_today');
        }
        const entityConfig = this.config?.entities ? this.config.entities[entityKey] : undefined;
    ...
    render() {
        if (!this.config || !this.hass) {
            return b `<p style="color: red; padding: 16px;">Wachten op Home Assistant...</p>`;
        }
        ...
        const solar = this.getEntityValue(entities.solar || entities.solar_power);
        const load = this.getEntityValue(entities.load || entities.home_power);
        const rawBatteryPower = this.debugBatteryPower !== null ? this.debugBatteryPower : this.getEntityValue(entities.battery_power || entities.battery);
        const soc = this.debugBatterySoc !== null ? this.debugBatterySoc : (entities.battery_soc || entities.battery_percentage ? this.getEntityValue(entities.battery_soc || entities.battery_percentage) : 0);
        ...
        let grid = 0;
        if (entities.grid || entities.grid_power) {
            grid = this.getEntityValue(entities.grid || entities.grid_power);
        }
        ...
        const statusEntity = entities.battery_status || entities.battery_state;
        ...
        else if (entities.grid || entities.grid_power) {
        ...
        gridPriceState ? (gridPriceState.attributes.unit_of_measurement || '€/kWh') : '€/kWh';
        ...
        const showSolar = this.config?.show_solar !== undefined
            ...
            : (!!entities.solar || !!entities.solar_power);
        const showBattery = this.debugShowBattery !== null
            ...
            : (this.config?.show_battery !== undefined
                ...
                : (!!entities.battery_power || !!entities.battery));
        ...
        let resolvedShowLights = undefined;
            ...
            ${this._weatherTestPanelOpen ? b `
              <div @click=${(e) => e.stopPropagation()} style="position: absolute; left: 16px; top: 52px; z-index: 99; background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.15); width: 280px; max-height: 75vh; overflow-y: auto; border-radius: 12px; padding: 16px; color: #fff; font-family: system-ui, sans-serif; box-shadow: 0 8px 32px rgba(0,0,0,0.4); display: flex; flex-direction: column; gap: 12px; box-sizing: border-box;">
                <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 8px;">
                  ...
                  <button @click=${(e) => { e.stopPropagation(); this._toggleWeatherTestPanel(); }} style="background: none; border: none; color: rgba(255,255,255,0.6); font-size: 18px; cursor: pointer; line-height: 1; padding: 0;">&times;</button>
                </div>

                <!-- Weather Selector -->
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  <span style="font-size: 10px; color: rgba(255,255,255,0.5); font-weight: bold; text-transform: uppercase;">Weertype</span>
                  <select @change=${(e) => this.debugWeatherState = e.target.value || null} style="background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.15); color: #fff; padding: 6px; border-radius: 6px; font-size: 12px; outline: none; cursor: pointer; width: 100%;">
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <input type="range" min="0" max="23.9" step="0.1" .value=${this.debugTimeHour !== null ? this.debugTimeHour : decimalHour} @input=${(e) => this.debugTimeHour = parseFloat(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                    ${this.debugTimeHour !== null ? b `<button @click=${() => this.debugTimeHour = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                  </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <input type="range" min="0" max="120" step="1" .value=${this.debugWindSpeed !== null ? this.debugWindSpeed : windSpeed} @input=${(e) => this.debugWindSpeed = parseInt(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                    ${this.debugWindSpeed !== null ? b `<button @click=${() => this.debugWindSpeed = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                  </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <div style="display: flex; gap: 4px;">
                    ${['light', 'normal', 'heavy'].map(mode => b `
                      <button @click=${() => this.debugRainIntensity = this.debugRainIntensity === mode ? null : mode} style="flex: 1; padding: 4px; font-size: 10px; border-radius: 4px; cursor: pointer; border: 1px solid rgba(255,255,255,0.15); background: ${this.debugRainIntensity === mode ? '#10b981' : 'rgba(0,0,0,0.2)'}; color: #fff; font-weight: 600;">
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <input type="range" min="-15" max="40" step="0.5" .value=${this.debugTemperature !== null ? this.debugTemperature : (temperature !== null ? temperature : 15)} @input=${(e) => this.debugTemperature = parseFloat(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                    ${this.debugTemperature !== null ? b `<button @click=${() => this.debugTemperature = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                  </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 4px; border-top: 1px solid rgba(255,255,255,0.15); padding-top: 8px;">
                  ...
                  <div style="display: flex; gap: 4px;">
                    ...
                    <button @click=${() => { this.debugShowBattery = true; if (this.debugBatteryPower === null)
            this.debugBatteryPower = 1500; if (this.debugBatterySoc === null)
            this.debugBatterySoc = 50; }} style="flex: 1; padding: 4px; font-size: 10px; border-radius: 4px; cursor: pointer; border: 1px solid rgba(255,255,255,0.15); background: ${this.debugShowBattery === true ? '#10b981' : 'rgba(0,0,0,0.2)'}; color: #fff; font-weight: 600;">
                      Altijd AAN
                    </button>
                ...
                ${showBattery ? b `
                  <div style="display: flex; flex-direction: column; gap: 4px;">
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                      <input type="range" min="-5000" max="5000" step="50" .value=${this.debugBatteryPower !== null ? this.debugBatteryPower : 0} @input=${(e) => this.debugBatteryPower = parseInt(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                      ${this.debugBatteryPower !== null ? b `<button @click=${() => this.debugBatteryPower = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                    </div>
                  </div>
                  ...
                  <div style="display: flex; flex-direction: column; gap: 4px;">
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                      <input type="range" min="0" max="100" step="1" .value=${this.debugBatterySoc !== null ? this.debugBatterySoc : 50} @input=${(e) => this.debugBatterySoc = parseInt(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                      ${this.debugBatterySoc !== null ? b `<button @click=${() => this.debugBatterySoc = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                    </div>
                  </div>
                ` : ''}
                ...
                <div style="display: flex; flex-direction: column; gap: 4px; border-top: 1px solid rgba(255,255,255,0.15); padding-top: 8px;">
                  ...
                  <div style="display: flex; gap: 4px;">
                    ...
                    <button @click=${() => { this.debugShowEV = true; if (this.debugEVPower === null)
            this.debugEVPower = 3600; }} style="flex: 1; padding: 4px; font-size: 10px; border-radius: 4px; cursor: pointer; border: 1px solid rgba(255,255,255,0.15); background: ${this.debugShowEV === true ? '#10b981' : 'rgba(0,0,0,0.2)'}; color: #fff; font-weight: 600;">
                      Altijd AAN
                    </button>
                ...
                ${showEV ? b `
                  <div style="display: flex; flex-direction: column; gap: 4px; margin-bottom: 8px;">
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                      <input type="range" min="0" max="11000" step="100" .value=${this.debugEVPower !== null ? this.debugEVPower : 0} @input=${(e) => this.debugEVPower = parseInt(e.target.value)} style="flex: 1; cursor: pointer; accent-color: #10b981;" />
                      ${this.debugEVPower !== null ? b `<button @click=${() => this.debugEVPower = null} style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Reset</button>` : ''}
                    </div>
                  </div>
                ` : ''}
...
EnergyFlowCard.styles = styles;
__decorate([
    n({ attribute: false })
], EnergyFlowCard.prototype, "hass", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "config", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "selectedNode", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "cardWidth", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "cardHeight", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "hasActiveHash", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "activePopup", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "activePopupHistory", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "isLoadingHistory", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "activeTab", void 0);
__decorate([
    r()
...
__decorate([
    r()
], EnergyFlowCard.prototype, "hourlyStatsData", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "weatherForecast", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "hoveredPoint", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugWeatherState", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugTimeHour", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugWindSpeed", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugRainIntensity", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugTemperature", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugBatteryPower", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugBatterySoc", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugEVPower", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugShowBattery", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugShowEV", void 0);
__decorate([
    r()
], EnergyFlowCard.prototype, "debugPoolPumpActive", void 0);
__decorate([
    r()
...
if (!customElements.get('energy-flow-card')) {
    ...
    console.info(`%c  ENERGY-FLOW-CARD  %c Version 2.3.3 `, 'color: white; background: #10b981; font-weight: 700;', 'color: #10b981; background: #0f172a; font-weight: 700;');
}

export { EnergyFlowCard };
