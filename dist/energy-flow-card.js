...
`,gt={solar:{stroke:"#10b981",glow:"rgba(16,185,129,0.5)"},battery:{stroke:"#10b981",glow:"rgba(16,185,129,0.5)"},batteryD:{stroke:"#ef4444",glow:"rgba(239,68,68,0.5)"},gridI:{stroke:"#06b6d4",glow:"rgba(6,182,212,0.5)"},gridE:{stroke:"#22c55e",glow:"rgba(34,197,94,0.5)"},ev:{stroke:"#a855f7",glow:"rgba(168,85,247,0.5)"},home:{stroke:"#e2e8f0"}},xt=[{hour:0,top:"#020617",horizon:"#0f172a",stars:.8,lights:1,clouds:"rgba(255, 255, 255, 0.08)"},{hour:4.5,top:"#020617",horizon:"#0f172a",stars:.8,lights:1,clouds:"rgba(255, 255, 255, 0.08)"},{hour:6,top:"#1e1b4b",horizon:"#fdba74",stars:.2,lights:.3,clouds:"rgba(255, 255, 255, 0.35)"},{hour:8,top:"#0ea5e9",horizon:"#bae6fd",stars:0,lights:0,clouds:"rgba(255, 255, 255, 0.65)"},{hour:17,top:"#0284c7",horizon:"#bae6fd",stars:0,lights:0,clouds:"rgba(255, 255, 255, 0.65)"},{hour:19.5,top:"#3b0764",horizon:"#f97316",stars:0,lights:.5,clouds:"rgba(255, 255, 255, 0.45)"},{hour:21,top:"#18113c",horizon:"#ea580c",stars:.1,lights:1,clouds:"rgba(255, 255, 255, 0.18)"},{hour:22.5,top:"#020617",horizon:"#1e293b",stars:.6,lights:1,clouds:"rgba(255, 255, 255, 0.08)"},{hour:24,top:"#020617",horizon:"#0f172a",stars:.8,lights:1,clouds:"rgba(255, 255, 255, 0.08)"}];function ut(t){const e=t.replace("#","");return{r:parseInt(e.substring(0,2),16),g:parseInt(e.substring(2,4),16),b:parseInt(e.substring(4,6),16)}}function kt(t,e,i){if(t.startsWith("rgba")||e.startsWith("rgba")){const r=t=>{const e=t.match(/[\d.]+\)$/);return e?parseFloat(e[0]):1},o=r(t);return`rgba(255, 255, 255, ${o+(r(e)-o)*i})`}const r=ut(t),o=ut(e);return function(t,e,i){const r=t=>{const e=Math.max(0,Math.min(255,Math.round(t))).toString(16);return 1===e.length?"0"+e:e};return`#${r(t)}${r(e)}${r(i)}`}(r.r+(o.r-r.r)*i,r.g+(o.g-r.g)*i,r.b+(o.b-r.b)*i)}function wt(t){let e=xt[0],i=xt[xt.length-1];for(let r=0;r<xt.length-1;r++)if(t>=xt[r].hour&&t<=xt[r+1].hour){e=xt[r],i=xt[r+1];break}const r=i.hour-e.hour,o=0===r?0:(t-e.hour)/r;return{top:kt(e.top,i.top,o),horizon:kt(e.horizon,i.horizon,o),stars:e.stars+(i.stars-e.stars)*o,lights:e.lights+(i.lights-e.lights)*o,clouds:kt(e.clouds,i.clouds,o)}}function $t(t){const e=Math.abs(t);return e<20?0:e<1e3?16:6}function bt(t){const e=Math.abs(t);return e>=1e3?`${(e/1e3).toFixed(1)} kW`:`${Math.round(e)} W`}function mt(t,e,i,r=1,o="#ffffff",s=.9){return B`
  ...
  `}function vt({houseStyle:t="modern-villa",carType:e="hatchback",timeHour:i,timeOfDay:r,solar:o,solarToday:s,load:l,batteryPower:n,soc:a,charger:h,grid:c,showSolar:d,showBattery:f,showEV:y,weather:p="sunny",sunriseHour:g=6,sunsetHour:x=21,gridImportToday:u=null,gridExportToday:k=null,homeToday:w=null,batteryChargeToday:$=null,batteryDischargeToday:b=null,evToday:m=null,onNodeClick:v}){let _=i;_=i>=g&&i<=x?6+(i-g)/(x-g)*15:i>x?21+(i-x)/(24-x)*3:i/g*6;const A=n>.05,E=n<-.05,M=c>.05,S=c<-.05,C=h>.1,L=o>20,P=l>20,T=A||E&&S?gt.battery:gt.batteryD,O=M?gt.gridI:gt.gridE,R=wt(_),H=R.lights>.05||"rainy"===p||"lightning"===p;let N=R.top,U=R.horizon,G=R.clouds,D="night"===r?.18:.48;"cloudy"===p?(N=kt(R.top,"#475569",.5),U=kt(R.horizon,"#94a3b8",.5),G="rgba(241, 245, 249, 0.55)",D=.65):"rainy"===p||"lightning"===p?(N=kt(R.top,"#1e293b",.75),U=kt(R.horizon,"#475569",.75),G="rgba(100, 116, 139, 0.5)",D=.65):"snowy"===p?(N=kt(R.top,"#cbd5e1",.4),U=kt(R.horizon,"#f1f5f9",.4),G="rgba(255, 255, 255, 0.6)",D=.7):"foggy"===p&&(N=kt(R.top,"#94a3b8",.6),U=kt(R.horizon,"#cbd5e1",.6),G="rgba(226, 232, 240, 0.4)",D=.5);const I={cx:480,cy:600};let z=0,F="#fef08a",W="rgba(254, 240, 138, 0.65)";if(_>=6&&_<=21&&"rainy"!==p&&"lightning"!==p&&"cloudy"!==p){const t=(_-6)/15;I.cx=1080*t-60,I.cy=576-528*Math.sin(t*Math.PI),z=Math.max(0,Math.min(1,1.5*Math.sin(t*Math.PI)));const e=Math.sin(t*Math.PI);F=kt("#ea580c","#fef08a",e),W=kt("rgba(234, 88, 12, 0.65)","rgba(254, 240, 138, 0.75)",e)}const j={cx:480,cy:600};let V=0;if((_>21||_<6)&&"rainy"!==p&&"lightning"!==p&&"cloudy"!==p){const t=_>21?(_-21)/9:(_+3)/9;j.cx=1080*t-60,j.cy=576-480*Math.sin(t*Math.PI),V=Math.max(0,Math.min(.9,1.8*Math.sin(t*Math.PI)))}const Z=_>=8&&_<=18,Q=Z?"url(#window-day)":H?"url(#window-night)":"url(#window-dark)",X=Z?"none":H?"drop-shadow(0 0 6px rgba(251, 191, 36, 0.45))":"none",Y=t=>450+1.15*(t-450),q=t=>480+1.15*(t-480),K=Math.round(Y(345)),J=Math.round(q(420)),tt=Math.round(Y(380)),et=Math.round(q(300));let it=S?"↑ Teruglevering":M?"↓ Import":"Standby";null!==u&&null!==k?it=`↓${u.toFixed(1)} ↑${k.toFixed(1)} kWh`:null!==u?it=`Import: ${u.toFixed(1)} kWh`:null!==k&&(it=`Terug: ${k.toFixed(1)} kWh`);const rt=null!==w?`Vandaag: ${w.toFixed(1)} kWh`:P?"Actief":"Standby";let ot=`SoC: ${a}%`;null!==$&&null!==b?ot=`SoC: ${a}% (↓${$.toFixed(1)} ↑${b.toFixed(1)})`:null!==$&&(ot=`SoC: ${a}% (↓${$.toFixed(1)})`);const st=null!==m?`Vandaag: ${m.toFixed(1)} kWh`:C?"Bezig met laden":"Standby",lt=[{id:"grid",title:"Stroomnet",value:bt(c),sub:it,color:O.stroke,active:M||S},{id:"home",title:"Huisverbruik",value:bt(l),sub:rt,color:gt.home.stroke,active:P}];f&&lt.push({id:"battery",title:"Thuisaccu",value:bt(n),sub:ot,color:T.stroke,active:A||E}),y&&lt.push({id:"ev",title:"Laadpaal (EV)",value:bt(h),sub:st,color:gt.ev.stroke,active:C});const nt=(960-170*lt.length)/(lt.length+1),at=(t,e,i,r,o,s=!1)=>B`
      ...
      ${((t,e,i,r,o,s=!1)=>e&&0!==i?B`
      ${Array.from({length:3}).map((e,l)=>B`
        <circle r="3.5" fill="${r}"
          style="
            offset-path: path('${t}');
    ...
    <svg viewBox="0 0 960 590" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clip-path="url(#scene-clip)">
        ...
        <!-- Stars -->
        ${R.stars>.05&&"rainy"!==p&&"lightning"!==p&&"cloudy"!==p?B`
        ...
        ${V>0?B`
          <g style="pointer-events: none;" opacity="${V}">
            <circle cx="${j.cx}" cy="${j.cy}" r="30" fill="#e2e8f0" opacity="0.15" style="filter: blur(4px);" />
            <circle cx="${j.cx}" cy="${j.cy}" r="17" fill="#f1f5f9" />
            <circle cx="${j.cx+6}" cy="${j.cy-4}" r="16" fill="url(#sky-grad)" />
          </g>
        `:""}
        ...
        ${"cloudy"===p||"rainy"===p||"lightning"===p?B`
        ...
        ${"rainy"===p?B`
    <g style="pointer-events: none;">
      ${Array.from({length:18}).map((t,e)=>B`
  ...
  `:""}
        ${"snowy"===p?B`
    <g style="pointer-events: none;">
      ${Array.from({length:22}).map((t,e)=>B`
  ...
  `:""}
          ...
          <g id="house-structure" class="interactiveGroup homeGroup" @click=${()=>v("home")}>
            ${"modern-villa"===t?B`
              ...
              <g id="house-door">
                ...
                <rect x="317" y="390" width="6" height="70" fill="${H?"#fde047":"#1e293b"}" stroke="#451a03" stroke-width="0.8" style="fill: ${H?`rgba(253, 224, 71, ${R.lights})`:"#1e293b"}; filter: ${H?`drop-shadow(0 0 4px rgba(253, 224, 71, ${R.lights}))`:"none"}; transition: fill 0.5s ease;" />
            ...
            ${"classic-jaren30"===t?B`
              ...
              ${Array.from({length:50}).map((t,e)=>{const i=450-6*e;if(i<150)return"";let r=290,o=590;return i<370&&(r=290+.682*(370-i),o=590-.682*(370-i)),B`<line x1="${r}" y1="${i}" x2="${o}" y2="${i}" stroke="#7f1d1d" stroke-width="0.5" opacity="0.4" />`})}
              ...
              ${Array.from({length:14}).map((t,e)=>{const i=450-6*e;return B`<line x1="260" y1="${i}" x2="290" y2="${i}" stroke="#7f1d1d" stroke-width="0.5" opacity="0.4" />`})}
              ...
              <rect x="272" y="385" width="6" height="30" fill="${H?"#fde047":"#0f172a"}" opacity="0.8" style="fill: ${H?`rgba(253, 224, 71, ${R.lights})`:"#0f172a"}; transition: fill 0.5s ease;" />
              ...
              ${Array.from({length:20}).map((t,e)=>{const i=150+6*e;if(i>265)return"";const r=78.5/115*(i-150);return B`<line x1="${440-r}" y1="${i}" x2="${440+r}" y2="${i}" stroke="#0f172a" stroke-width="0.8" opacity="0.45" />`})}
            ...
            ${"barnhouse"===t?B`
              ...
              ${Array.from({length:26}).map((t,e)=>B`
            ...
            ${"townhouse"===t?B`
              ...
              ${Array.from({length:32}).map((t,e)=>B`
            ...
            ${"modern-villa"!==t&&"classic-jaren30"!==t&&"barnhouse"!==t&&"cubist-bungalow"!==t&&"townhouse"!==t?B`
              <!-- LEFT WING -->
              <g id="left-wing">
            ...
            <g id="ev-car" class="interactiveGroup evGroup" opacity="${C?1:.4}" style="transition: opacity 0.6s ease;" @click=${t=>{t.stopPropagation(),v("ev")}}>
              ${"hatchback"===e?B`
                <g transform="translate(490, 430)">
                  ...
                  ${Array.from({length:6}).map((t,e)=>{const i=e*Math.PI/3;return B`<line x1="32" y1="50" x2="${32+10*Math.cos(i)}" y2="${50+10*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.2" />`})}
                  <circle cx="118" cy="50" r="16" fill="#090d16" />
                  <circle cx="118" cy="50" r="10" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({length:6}).map((t,e)=>{const i=e*Math.PI/3;return B`<line x1="118" y1="50" x2="${118+10*Math.cos(i)}" y2="${50+10*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.2" />`})}
                </g>
              `:""}
              ${"sedan"===e?B`
                <g transform="translate(500, 432)">
                  ...
                  ${Array.from({length:7}).map((t,e)=>{const i=2*e*Math.PI/7;return B`<line x1="30" y1="44" x2="${30+8.5*Math.cos(i)}" y2="${44+8.5*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.2" />`})}
                  <circle cx="103" cy="44" r="13.5" fill="#090d16" />
                  <circle cx="103" cy="44" r="8.5" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({length:7}).map((t,e)=>{const i=2*e*Math.PI/7;return B`<line x1="103" y1="44" x2="${103+8.5*Math.cos(i)}" y2="${44+8.5*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.2" />`})}
                </g>
              `:""}
              ${"suv"===e?B`
                <g transform="translate(500, 422)">
                  ...
                  ${Array.from({length:5}).map((t,e)=>{const i=2*e*Math.PI/5;return B`<line x1="31" y1="54" x2="${31+10*Math.cos(i)}" y2="${54+10*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.5" />`})}
                  <circle cx="104" cy="54" r="15.5" fill="#090d16" />
                  <circle cx="104" cy="54" r="10" fill="#475569" stroke="#cbd5e1" stroke-width="1.5" />
                  ${Array.from({length:5}).map((t,e)=>{const i=2*e*Math.PI/5;return B`<line x1="104" y1="54" x2="${104+10*Math.cos(i)}" y2="${54+10*Math.sin(i)}" stroke="#cbd5e1" stroke-width="1.5" />`})}
                </g>
              `:""}
            </g>
          `:""}
        ...
        <!-- ════════════════════════════════════════════════════════════════ -->
        ${d?at(`M ${tt},${et} L ${tt},${q(408)} L ${K},${q(408)} L ${K},${J}`,L,$t(o),gt.solar.stroke,gt.solar.glow):""}

        ${at(`M 192,455 L 192,493 L ${K},493 L ${K},${J}`,M||S,$t(c),O.stroke,O.glow,S)}

        ${f?at(`M ${Y(310)},${q(420)} L ${K},${J}`,A||E,$t(n),T.stroke,T.glow,A):""}

        ${y?at(`M ${K},${J} L ${K},503 L 664,503 L 664,415`,C,$t(h),gt.ev.stroke,gt.ev.glow):""}
