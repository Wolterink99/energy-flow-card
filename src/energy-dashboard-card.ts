                ...
                <g transform="translate(${xR}, ${yT})">
                  ...
                  <foreignObject x="${-rDisc}" y="${-rDisc}" width="${rDisc * 2}" height="${rDisc * 2}">
                    <div class="node-disc-content">
                      ...
                      <div class="mix-bar">
                        ${fracSolar > 0 ? html`<div style="width: ${(fracSolar * 100).toFixed(0)}%; background: #f59e0b;" title="Zon"></div>` : ''}
                        ${fracBat > 0 ? html`<div style="width: ${(fracBat * 100).toFixed(0)}%; background: #10b981;" title="Batterij"></div>` : ''}
                        ${fracGrid > 0 ? html`<div style="width: ${(fracGrid * 100).toFixed(0)}%; background: #38bdf8;" title="Net"></div>` : ''}
                      </div>
                      ...
                      ` : html`
                        <span class="node-status-pill pill-amber" style="padding: 1px 4px; font-size: 8.5px;">
                          ${fracSolar > 0 ? html`☀️${Math.round(fracSolar*100)}% ` : ''}
                          ${fracBat > 0 ? html`🔋${Math.round(fracBat*100)}% ` : ''}
                          ${fracGrid > 0 ? html`⚡${Math.round(fracGrid*100)}%` : ''}
                        </span>
                      `}
                    </div>
                  </foreignObject>
